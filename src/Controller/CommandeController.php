...
class CommandeController extends AbstractController
{
    ...
    #[Route("/admin/commande/TrierParDateDESC", name: "TrierParDateDESC")]
    ...
    #[Route("/admin/commande/new/{id}", name: "commande_new", methods: ["GET","POST"])]
    ...
    #[Route("/admin/commande/{idc}", name: "commande_delete", methods: ["POST"])]
    ...
    #[Route("/admin/commande/list/{id}", name: "commande_list", methods: ["GET"])]
